  ...
  private async processPostGeneration(
    ...
    const visionResponse = await this.openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: `أنت منشئ محتوى احترافي متخصص في إنشاء محتوى  لمشاركات بطولة دوري الذكاء الاصطناعي في السعودية.
          تقوم بإنشاء منشورات جذابة للوسائط الاجتماعية مستندة إلى الصور، تُظهر تميز المشارك وروح التحدي، وتشمل رسالة وداع مؤثرة للحضور.
          يجب أن تكون جميع المخرجات باللغة العربية الفصحى، موجزة، محفّزة، ومناسبة للنشر على منصات التواصل.`
        },
        {
          role: 'user',
          content: [
            {
              type: 'text',
              text: `حلل هذه الصورة لمشارك في دوري الذكاء الاصطناعي في السعودية وأنشئ منشوراً جذاباً ومؤثراً.
              يجب أن يتضمّن المنشور رسالة وداع للحضور تعبّر عن الامتنان والمشاعر بعد انتهاء الحدث.
              ركّز على قوة الحضور، التفاعل مع التكنولوجيا أو الذكاء الاصطناعي، وأي عناصر أخرى بارزة.
              يجب أن لا يتجاوز المنشور 280 حرفاً، وأن يكون باللغة العربية الفصحى.` 
            },
            {
              type: 'image_url',
              image_url: {
